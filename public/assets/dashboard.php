...
<html lang="en">
  <head>
    ...
    <title>StarCodeKh - Workspace Dashboards</title>
    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
      ...
      <div class="sidebar print:hidden">
        ...
        <div class="main-sidebar">
          <div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
            ...
            <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
              <!-- Dashobards -->
              <a href="dashboards-workspace.html" class="flex size-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="'Dasbor Mahasiswa'">
              ...
              <!-- Apps -->
              <a href="" class="flex size-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Biodata Mahasiswa'">
              ...
              <!-- Pages And Layouts -->
              <a href="" class="flex size-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Jadwal Kuliah'">
                <svg class="size-7" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- Forms -->
              <a href="" class="flex size-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Isian Rancangan Studi'">
                <svg class="size-7" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- Components -->
              <a href="" class="flex size-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Hasil Studi Mahasiswa'">
                <svg class="size-7" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- Elements -->
              <a href="" class="flex size-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Saran dan Kritik'">
                <svg class="size-7" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="sidebar-panel">
          <div class="flex h-full grow flex-col pl-[var(--main-sidebar-width)] dark:bg-navy-750">
      ...
      <nav class="header before:bg-white dark:before:bg-navy-750 print:hidden">
        ...
        <div class="header-container relative flex w-full bg-white dark:bg-navy-750 print:hidden">
          ...
          <div class="flex w-full items-center justify-between">
            ...
            <div class="size-7">
              <button class="menu-toggle ml-0.5 flex size-7 flex-col justify-end space-y-1.5 text-primary outline-none focus:outline-none dark:text-accent-light/80 sm:hidden md:hidden lg:hidden xl:hidden" :class="$store.global.isSidebarExpanded && 'active'" @click="$store.global.isSidebarExpanded = !$store.global.isSidebarExpanded">
                <span></span>
                <span></span>
                <span></span>
              </button>
          ...
          <div class="card group col-span-12 lg:col-span-7">
            <div class="mt-3 flex items-center justify-between px-4 sm:px-5">
              <div class="flex flex-1 items-center justify-between space-x-2 sm:flex-initial">
                <h2 class="text-sm+ font-bold tracking-wide text-slate-700 dark:text-navy-100">
                  Ikhtisar Data Mahasiswa
                </h2>
                <div x-data="usePopper({placement:'bottom-start',offset:4})" @click.outside="isShowPopper && (isShowPopper = false)" :class="!isShowPopper && 'sm:opacity-0'" class="inline-flex focus-within:opacity-100 group-hover:opacity-100">
                  ...
                  <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                    <div class="popper-box rounded-md border border-slate-150 bg-white py-1.5 font-inter dark:border-navy-500 dark:bg-navy-700">
                      <ul>
                        <li>
                          <a href="#" class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Ubah Data</a>
                        </li>
                    </div>
                  </div>
                </div>
            ...
            <div class="ax-transparent-gridline pr-2">
              <!-- isi ringkasan data mahasiswa -->
            </div>
          </div>

          <div class="order-first col-span-12 grid grid-cols-2 gap-4 sm:order-none sm:gap-5 lg:col-span-5 lg:gap-6">

            <div class="card py-5 px-2 text-center">
              <p class="font-bold tracking-wide text-slate-700 dark:text-navy-100">
                Prestasi Akademik
              </p>
              <div class="flex flex-col justify-between mt-2">

                <div class="flex flex-col mb-2">
                  <div class="font-medium tracking-wide text-slate-500 dark:text-navy-100 mt-3">
                  IPk
                </div>              
                <div class="font-medium fa-3x tracking-wide text-slate-500 dark:text-navy-100 mt-3">
                  0.00
                </div>
              </div>
            ...
            <div class="flex flex-col sm:gap-3 lg:gap-4 gap-3 justify-center">

            <div class="card justify-center p-4">
              <div class="flex flex-col">
                <div class="text-xs+ font-bold text-slate-800 dark:text-navy-100 text-center">
                  Semester Akademik Sekarang
                </div>
                <div class="text-2xl font-semibold text-slate-500 dark:text-navy-100 text-center mt-2">
                  2024/2025
                </div>
                </div>
            </div>
            ...
            <div class="card justify-center p-4">
              <div class="flex flex-col">
                ...
                <div class="flex justify-center mt-2">
                  <div class="text-2xl font-semibold text-white dark:text-white bg-success w-max p-2 rounded">
                    Aktif
                  </div>
                </div>
              </div>
