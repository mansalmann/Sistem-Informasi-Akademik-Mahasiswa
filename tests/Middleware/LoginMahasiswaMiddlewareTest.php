...
namespace ProgrammerSalman\SistemInformasiAkademikMahasiswa\Middleware{
    ...
    class LoginMahasiswaMiddlewareTest extends TestCase{

        private LoginMahasiswaMiddleware $middleware;
        private SessionsMahasiswaRepository $repository;

        protected function setUp():void{
            $this->middleware = new LoginMahasiswaMiddleware();
            putenv("mode=test");
        ...
        public function testBefore(){
            ...
            self::expectOutputRegex("#Location: /login#");
        }
